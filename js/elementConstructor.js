...
const links = [
    ...
    {
        href: `https://opencollective.com/amogos`,
        name: `Donate`,
        id: `donate`,
        icon: "nf-md-hand_heart",
    },
];

const socialLinks = [
    {
        href: `https://discord.gg/z86muknm9y`,
        name: `Discord`,
        id: `discord`,
        icon: "nf-md-discord",
    },
    {
        href: `https://github.com/amog-os/`,
        name: `GitHub`,
        id: `github`,
        icon: "nf-md-github",
    },
    {
        href: `https://www.reddit.com/r/amogOS/`,
        name: `Reddit`,
        id: `reddit`,
        icon: "nf-md-reddit",
    },
...
function footerConstructor() {
    ...
    footer.appendChild(
        createElement(
            "div",
            ["logo"],
            '<img src="img/toppat-banner-light.png" alt="Logo" class="logo__image">'
        )
    );
    ...
    const text = createElement(
        "div",
        ["footer__text", "footer__subsection"],
        textContent
    );
